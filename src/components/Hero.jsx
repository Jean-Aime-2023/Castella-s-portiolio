...
const Hero = () => {
  return (
    <div id="hero" className='flex flex-row text-white mt-[17rem] 2xl:px-[28rem] gap-10 max-md:flex-col items-center justify-center max-md:items-center max-md:text-center max-md:px-[2rem] sm:px-[4rem] max-md:mt-[12rem]'>

...
const WhoIamI = () => {
  return (
    <div id='about' className='mt-[20rem] max-sm:mt-[14rem] text-white max-sm:px-[4rem] max-sm:text-center xl:px-[12rem] max-xl:px-[6rem] '>
          ...
          <section className='prehvihear flex flex-col gap-3'>
            ...
            <p className='flex gap-3 flex-row max-lg:flex-col'>
              ...
              <span className='flex flex-row gap-4'><img src={log} alt="/" className='max-sm:hidden' />{' '}
                <Link to={'https://rca.ac.rw/'} target="_blank" rel="noopener noreferrer" className='text-[#1877F2]'>Rwanda Coding Academy</Link>
              </span>
            </p>
          </section>
